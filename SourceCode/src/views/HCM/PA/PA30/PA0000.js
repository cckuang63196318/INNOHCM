// 1.config editForm, dataTable. 注意這只是設定，
// 若要改變form data要用PA0000.editForm.form.PA0000_BEGDA.value = '2023-01-02' 這種方式
const form = {
    PA0000_ID: { 
        value: '', type: 'null', 
